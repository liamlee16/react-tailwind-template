...
import DropDownMenu from "../../components/elements/ddm/DropDownMenu";
import DropDownMenuWithForm from "../../components/elements/ddm/DropDownMenuWithForm";
import LargeDropDownMenu from "../../components/elements/ddm/LargeDropDownMenu";
...
function MenuList() {
  ...
  return (
    <div className="w-full grid grid-cols-6 gap-4">
      ...
      <div className="w-full px-4 py-2 bg-white shadow-lg">
        <div className="text-lg text-center py-2 mb-4 border-gray-400 border-b">
          With Icon on items with divider
        </div>
        <DropDownMenu
          icon={
            <svg
      ...
      <div className="w-full px-4 py-2 bg-white shadow-lg">
        <div className="text-lg text-center py-2 mb-4 border-gray-400 border-b">
          With Icon on items with description
        </div>
        <DropDownMenu
          icon={
            <svg
      ...
      <div className="w-full px-4 py-2 bg-white shadow-lg col-span-2">
        ...
        <DropDownMenuWithForm label={"By name"} forceOpen={false} />
      </div>
    </div>
  );
}
